...
export function ModelShowcase({
  ...
  return (
    <section className="mx-auto grid w-full max-w-7xl gap-8 px-6 py-20 md:grid-cols-[1.1fr_0.9fr] lg:px-10">
      <div className="relative overflow-hidden rounded-[2rem] border border-slate-200 bg-[radial-gradient(circle_at_top,rgba(191,219,254,0.55),transparent_44%),linear-gradient(145deg,#ffffff,#eff6ff)] p-8 shadow-[0_26px_70px_rgba(148,163,184,0.22)]">
      ...
      <div className="flex flex-col justify-center gap-8">
        {eyebrow ? (
          <p className="text-xs font-medium uppercase tracking-[0.4em] text-sky-700">
            {eyebrow}
          </p>
        ) : null}
        ...
        <div className="space-y-4">
          ...
          {text ? (
            <div className="prose prose-lg max-w-xl prose-slate prose-p:text-slate-700 prose-strong:text-slate-950">
